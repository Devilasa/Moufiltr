...
//
// Prototypes per il control device e gli IOCTL user-mode, Aggiunti
//
EVT_WDF_IO_QUEUE_IO_DEVICE_CONTROL MouFiltr_EvtIoDeviceControl;
NTSTATUS MouFiltr_CreateControlDevice(_In_ WDFDRIVER Driver);
EVT_WDF_DRIVER_UNLOAD MouFiltr_EvtDriverUnload;
