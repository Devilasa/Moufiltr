...
- copy the .sys file in this directory:  C:\Windows\System32\drivers

- run in admin prompt this command -> sc create moufiltr type= kernel start= demand error= normal ^
